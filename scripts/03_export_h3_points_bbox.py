...
def main(args):
    try:
        ...
        # --- Build H3 cells and evaluate at their centers ---
        cells, cell_to_latlng = build_h3_cells_in_bbox(BBOX_WGS84_COORDS, args.h3_res)
        print(f"Generated {len(cells)} H3 cells at res {args.h3_res} inside BBOX.")
